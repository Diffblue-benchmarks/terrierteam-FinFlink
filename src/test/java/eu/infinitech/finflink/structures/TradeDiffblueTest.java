...
class TradeDiffblueTest {
  ...
  void testGettersAndSetters() {
    ...
    actualTrade.setAssetSymbol(ToTradeFactory.createTradeDataString());
  ...
  void testNewTrade() {
    // Arrange and Act
    Trade actualTrade = new Trade(ToTradeFactory.createTradeDataString(), 1L, 10.0d, 1L);

    // Assert
    assertEquals("AAPL,1000000,150.5,1000", actualTrade.getAssetSymbol());
  ...
  void testCompareToWithTradingData2() {
    // Arrange
    Trade trade = new Trade(ToTradeFactory.createTradeDataString(), 1L, 10.0d, 1L);
    Trade o = new Trade(ToTradeFactory.createTradeDataString(), 1L, 10.0d, 1L);
